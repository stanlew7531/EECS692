...
from kpnet.utils.imgproc import PixelCoord, get_guassian_heatmap, get_bbox_cropped_image_path
from kpnet.dataHandling.keypoint_db import KeypointDB
...
class KeypointDataset(data.Dataset):
    ...
    def __init__(self, config: KeypointDatasetConfig):
        # General config
    ...
    def __getitem__(self, index):
        ...
        from kpnet.utils.imgproc import rgb_image_normalize, depth_image_normalize
    ...
    def get_processed_entry(self, entry: KeypointDBEntry) -> ProcessedEntry:
        """
    ...
    def _get_geometric_augmentation_parameter(self, entry: KeypointDBEntry) -> (float, float):
        """
    ...
    def _get_transformed_keypoint(
        ...
        """
        from kpnet.utils.imgproc import transform_2d, PixelCoord, pixel_in_bbox
